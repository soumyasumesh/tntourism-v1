;(function(factory) {
    ...
    ShowMoreItems = (function() {
        ...
        function ShowMoreItems(element, settings) {
            ...
            var defaults = {
                ...
                afterNum:1,
                original:false,
                moreText: `Load more <i class="las la-angle-down font-16"></i>`,
                noMoreText: '',
                backMoreText:'Reset',
                responsive:''
            }
    ...
    ShowMoreItems.prototype.runData = function(element, settings) {
        ...
        $(element).next('.loadmore-box').remove()
        ...
        if(!_.goOut){
            $(element).after('<div class="loadmore-box text-end"><button class="addListData border-0 py-2 px-3 primary-bg text-dark">'+settings.options.moreText+'</button></div>');
        }
